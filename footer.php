	...
	<div class="container qp-global-footer__inner">
		<div class="qp-global-footer__brand">
			<div class="qp-global-footer__brand-top">
				<img class="qp-global-footer__logo" src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/qpedia-logo-white.png' ); ?>" alt="<?php esc_attr_e( 'لوگوی کوانتوم پدیا', 'quantum-pedia-child' ); ?>" width="44" height="44" style="width:44px; height:44px; object-fit:contain;" decoding="async" />
