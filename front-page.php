...
<main id="primary" class="site-main">
	<div class="container qp-front">
		<section class="qp-front-hero">
			...
			<!-- لوگوی ۳بعدی جدید هیرو -->
			<div class="qp-front-hero__emblem-wrap" style="display:flex; justify-content:center; align-items:center; margin-bottom:18px;">
				<img class="qp-front-hero__emblem" src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/qpedia-hero-emblem.png' ); ?>" alt="<?php esc_attr_e( 'لوگوی هیرو کوانتوم پدیا', 'quantum-pedia-child' ); ?>" width="100" height="100" style="width:100px; height:100px; object-fit:contain; filter:drop-shadow(0 0 18px rgba(0, 229, 255, 0.45));" decoding="async" />
			</div>
